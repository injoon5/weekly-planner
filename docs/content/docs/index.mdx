...
| `/home` | everyone | Landing always (CTAs adapt when signed in) |
...
src/
  ...
  config.js             # VITE_INSTANT_APP_ID → APP_ID, grid constants, storage keys
  components/           # UI
  hooks/                # Feature hooks
  planner/              # PlannerProvider context for the signed-in shell
