...
- Query:
  ...
  - `locked=1` — password shares: soft demo grid under a low-opacity gradient veil + Lucide lock
...
| Password | Generic “password required” — **no board name, owner, or events**; veiled demo grid + lock |
