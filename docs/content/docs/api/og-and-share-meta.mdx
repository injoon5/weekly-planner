...
- Query:
  ...
  - `locked=1` — password shares: blur the demo grid and overlay a Lucide lock
...
| Password | Generic “password required” — **no board name, owner, or events**; demo grid under thick blur + lock |
