...
- Query:
  ...
  - `locked=1` — password shares: empty grid with pastel gradient wash + Lucide lock
...
| Password | Generic “password required” — **no board name, owner, or events**; pastel gradient wash + lock |
