...
Source: `src/board/models.js` (+ `time.js`, `prefs.js`, `legacy.js`).
...
Config constants (`src/lib/config.js`): `SLOTS = 48`, `SLOT_MIN = 30`, `DAY_MIN = 1440`, `NEXT_DAY_START_SLOT = 36`.
